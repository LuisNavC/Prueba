...
const URI = 'http://localhost:8000/tramos/tramos-cliente';

const ComptTramosCliente = () => {
        ...
        <div className='row'>
            <div className='col'>
                <LineChart width={500} height={300} data={consuTramos}>
                    <XAxis dataKey="TipoConsumo" />
                    <YAxis />
                    <CartesianGrid stroke="#eee" strokeDasharray="5 5" />
                    <Line type="monotone" dataKey="TipoConsumo" stroke="#8884d8" />
                    <Line type="monotone" dataKey="Linea" stroke="#82ca9d" />
                    <Line type="monotone" dataKey="Perdidas" stroke="#ff0000" />
                </LineChart>
            </div>
            <div className='col'>
                <BarChart width={500} height={300} data={consuTramos}>
                    ...
                    <YAxis />
                    <CartesianGrid stroke="#eee" strokeDasharray="5 5" />
                    <Bar dataKey="TipoConsumo" fill="#8884d8" />
                    <Bar dataKey="Linea" fill="#82ca9d" />
                    <Bar dataKey="Perdidas" fill="#ff0000" />
                </BarChart>
            </div>
        </div>
        <hr></hr>
...
export default ComptTramosCliente;
